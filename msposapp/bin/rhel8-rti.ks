...
# Repos
url --url=http://myk.sh/rhel-8-for-x86_64-baseos/BaseOS
repo --name="AppStream" --install --baseurl=http://myk.sh/rhel-8-for-x86_64-appstream-rpms
repo --name="BaseOS" --install --baseurl=http://myk.sh/rhel-8-for-x86_64-baseos-rpms
