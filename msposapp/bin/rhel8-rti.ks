...
# Repos
url --url=https://media.myk.green/rhel-8-for-x86_64-baseos/BaseOS
repo --name="AppStream" --install --baseurl=https://media.myk.green/rhel-8-for-x86_64-appstream-rpms
repo --name="BaseOS" --install --baseurl=https://media.myk.green/rhel-8-for-x86_64-baseos-rpms
...
cd /bin
curl -O https://media.myk.green/ostools-1.17/updateos updateos
